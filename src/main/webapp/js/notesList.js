        ...
        columns:[[
            ...
            },
            {
                ...
                formatter:function (val,row) {
                    ...
                    a = '<a  id="add" data-id="98" class=" operA"  onclick="selectOne(\'' + rowEdit + '\')">查看</a> ';
...
function selectOne(rowEdit) {
    ...
    if (rows[2] == "") {
        $("#addForm input[name='operatorName']").val("");
    }
